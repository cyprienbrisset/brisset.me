...
export function Hero() {
  return (
    <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="hero-text-veil relative z-10 max-w-5xl mx-auto px-6 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-line bg-bg-alt/60 text-xs text-ink-muted font-mono mb-8">
          <span className="w-1.5 h-1.5 rounded-full bg-accent animate-pulse" />
          Disponible pour de nouveaux projets
        </div>
        <h1 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl leading-[1.02] tracking-tight">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-ink-muted text-xs font-mono tracking-widest z-10">
